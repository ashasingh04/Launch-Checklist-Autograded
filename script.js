...
window.addEventListener("load", function () {  
  ...
  form.addEventListener("submit", function (event) {  
    ...
    if (validateInput(pilotStatus) === `Empty`|| validateInput(copilotStatus) === `Empty`|| 
    validateInput(fuelStatus) === `Empty`||validateInput(cargoStatus) === `Empty`)
    {                    
        ...
        formSubmission(document,list,pilotStatus,copilotStatus,fuelStatus,cargoStatus);
    }
});
  let listedPlanets;
